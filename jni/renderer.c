...
void
Java_com_brentonbostick_eaglecell_MainActivity_nativeOnStart(JNIEnv* env, jobject thiz) {

}

void
Java_com_brentonbostick_eaglecell_MainActivity_nativeOnStop(JNIEnv* env, jobject thiz) {

}

void
Java_com_brentonbostick_eaglecell_MainActivity_nativeOnResume(JNIEnv* env, jobject thiz) {

}

void
Java_com_brentonbostick_eaglecell_MainActivity_nativeOnPauset(JNIEnv* env, jobject thiz) {

}

void
Java_com_brentonbostick_eaglecell_MainActivity_nativeSetSurface(JNIEnv* env, jobject thiz, jobject surface) {
